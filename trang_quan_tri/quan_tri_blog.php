...
?>
                                    <h4 class="box-title"> Quản Trị Blog </h4>
                                </div>
                                <div class="card-body--">
                                    <div class="table-stats order-table ov-h">
                                <table>
                                    <tr>
                                    <th><h4 class="box-title" style="" > </h4></th>
                                    <th><a href="../ElaAdmin-master/quan_tri_blog_them_moi.php"><button style="margin-left: 750px; color: #ffffff; background: #00C292;border: none; padding: 10px 15px;"> Thêm blog</button></a></th>
                                    </tr>
                                </table>
</div>
                                <div class="card-body--">
                                    ...
                                    ?>
                                            <tbody>
                                                <tr style="text-align: justify;">
                                                    ...
                                                    <td><a href="../ElaAdmin-master/quan_tri_blog_sua.php?id=<?php echo $row["id_blog"];?>"><img src="./images/edit.png" style="width: 32px; height: auto;"></a> <a href="../ElaAdmin-master/quan_tri_blog_xoa.php?id=<?php echo $row["id_blog"];?>"><img src="./images/delete.png" style="width: 32px; height: auto;"></a></td>
                                                </tr>
                                            </tbody>
                                            <?php }
                                            ?>
