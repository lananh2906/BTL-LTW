...
<body>
	...
	<form method="POST" action="./quan_tri_blog_sua_thuc_hien.php" enctype="multipart/form-data">
		...
		<p>
			Tác giả:<br>
			<input type="text" name="txtTacgia" style="width: 100%" value="<?php echo $row["tac_gia"];?>">
		</p>
		<p>
			Ngày đăng:<br>
			<input type="datetime" name="txtNgaydang" style="width: 100%" value="<?php echo $row["ngay_dang"];?>">
		</p>
		<p>
			Lượt xem:<br>
			<input type="varchar" name="txtLuotxem" style="width: 100%" value="<?php echo $row["luot_xem"];?>">
		</p>
